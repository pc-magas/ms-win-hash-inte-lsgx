...
void SGX_UBRIDGE(SGX_NOCONVENTION, o_print_hash, (unsigned char hash[32]));
void SGX_UBRIDGE(SGX_NOCONVENTION, o_print_encrypted_text, (unsigned char hash[32]));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_print_secret, (const char* str));
